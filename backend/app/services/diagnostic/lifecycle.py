"""Diagnostic bootstrap: build the initial diagnostic (topics + starter cards) for a new exam and track progress."""
...
from app.services.corpus.document_math_profile import classify_document_math_profile
from app.services.exams import create_exam
from app.services.generation.graph import generate_starter_cards_v2
from app.services.corpus.ingestion import UnsupportedDocumentTypeError, ingest_documents
from app.services.corpus.topics import build_topics_for_exam
