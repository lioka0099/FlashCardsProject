"""Apply a diagnostic answer: update topic proficiency/state within one transaction."""
...
from app.services.diagnostic.coverage import all_topics_diagnosed
from app.services.diagnostic.state import DiagnosticStateService
