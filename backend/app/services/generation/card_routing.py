"""Route a topic to a card type (math-calculation vs conceptual) using formula/vocabulary heuristics."""
...
from app.services.generation.difficulty_frameworks import CardRoute
from app.services.corpus.document_math_profile import normalize_document_math_kind
from app.services.math.classification import MathClassificationEvidence, MathClassificationService
