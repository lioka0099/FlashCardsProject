...
from app.services.learner.student_memory import StudentMemoryService
from app.services.learner.student_model import StudentModelService
from app.services.learner.teacher_model import TeacherModelService
from app.services.generation.card_routing import classify_card_route, default_route_decision
from app.services.generation.difficulty_frameworks import (
    card_info_for_difficulty,
    clamp_difficulty,
    framework_for_route,
    get_level,
)
from app.services.math.student_model import MathStudentModelService
from app.services.math.teacher_model import MathTeacherModelService
from app.services.math.verification import verify_math_solution, verify_compound_solution
...
from app.services.generation.cards import (
    GeneratedCard,
    pick_starter_topics,
)
...
def node_store_card(state: CardGenState) -> CardGenState:
    ...
    from app.services.corpus.qa import summarize_evidence
