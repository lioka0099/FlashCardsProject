"""Deterministic verification that a worked math answer is algebraically correct (SymPy equivalence)."""
...
def verify_compound_solution(
    ...
    *,
    ...
    """
    from app.services.math.solver import solve_math_problem  # local import avoids cycle
