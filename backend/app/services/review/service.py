"""Review service: entry point for recording a card review and returning the outcome."""
...
from app.services.diagnostic.review_reducer import DiagnosticReviewReducer
